...
/*
      ...
      */
      ...
      var Color =  360-Math.round(360*(kriging.predict(array_newlat[i],array_newlon[i], variogram)/1000));
     ...
     var infoWindow0 = new google.maps.InfoWindow({
      content: "<div>"+"中心點:"+P_center+"</Br>氣壓:"+kriging.predict(array_newlat[i],array_newlon[i], variogram)+"</div>",
      maxWidth: 500
    });
...
for (var s=0; s <nnlocationName.length; s++) {
 var Color = 360 - Math.round((360 * array_temp[s]/1000));
 ...
 var infoWindow = new google.maps.InfoWindow({
  content: "<div>"+nnlocationName[s].innerHTML+"</br>氣壓:"+nntemp[s].innerHTML+"</div>",
  maxWidth: 500
});
