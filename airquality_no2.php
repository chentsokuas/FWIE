        ...
        <form action="index.php">
         ...
         foreach($xml->children() as $books) { 
          if($books->SiteName!="" && $books->$no2!="")
          {
            ...
            <temp style="display: none;"><?php echo $books->$no2;?></temp>
            <?php
          }
        } 
        ?>
...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
  ...
  <div class="w3-container w3-section w3-padding-large w3-card-4 w3-light-grey">
   <ul class="w3-navbar w3-container w3-section w3-topbar w3-bottombar w3-border-red w3-pale-red w3-center " style="z-index:4;">
      ...
      <li class="w3-red"><a class="w3-hover-white w3-padding-16 w3-center" href="airquality_no2.php">二氧化氮(NO2)</a></li>
...
/*
     ...
     var infoWindow0 = new google.maps.InfoWindow({
      content: "<div>"+"中心點:"+P_center+"</Br>二氧化氮(NO2):"+kriging.predict(array_newlat[i],array_newlon[i], variogram)+"</div>",
      maxWidth: 500
    });
...
for (var s=0; s <nnlocationName.length; s++) {
 ...
 var infoWindow = new google.maps.InfoWindow({
  content: "<div>"+nnlocationName[s].innerHTML+"</br>二氧化氮(NO2):"+nntemp[s].innerHTML+"</div>",
  maxWidth: 500
});
