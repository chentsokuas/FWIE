...
<body>
  ...
  <nav class="w3-sidenav w3-collapse w3-light-green w3-animate-left" style="z-index:3;width:270px;margin-top:1%; " id="mySidenav">
      ...
      <input name="long" id="long" class="w3-input" value="3" style="display: none">
...
for($y=0;$y<sizeof($NewString)-1;$y++){
  ...
  if($NewString1[$y]>100)
      ...
      $NewString1[$y]=0;
  $zz=$y+1;
  $query="INSERT INTO `test`( `time`, `temperature`,`humidity`) VALUES ('".$datetime."','".$NewString[$y]."','".$NewString1[$y]."')";
  mysql_query($query);
  }
}
