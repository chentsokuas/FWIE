      ...
      <div class="w3-container w3-padding-top">
        <form action="index.php">
         ...
         foreach($xml->children() as $books) { 
          if($books->locationName !="" && $books->weatherElement[1]->elementValue->value > 0)
            { ?>
          ...
          <temp id="<?php echo "temp".$i;?>" style="display: none;"><?php echo $books->weatherElement[1]->elementValue->value;?></temp>
          <temp1 id="<?php echo "temp".$i;?>" style="display: none;"><?php echo $books->weatherElement[2]->elementValue->value;?></temp1>
          <?php
          $i++;
        }
      } 
  ...
  <div class="w3-container w3-section w3-padding-large w3-card-4 w3-light-grey">
   ...
   <script type="text/javascript">
    var myLatlng = new google.maps.LatLng(23.7, 120.9082103);
      ...
      var variogram1 = kriging.train(t1, x, y, model, sigma2, alpha);
...
/*
      ...
      */
      ...
      var Color =  kriging.predict(array_newlat[i],array_newlon[i], variogram);
     ...
     var infoWindow0 = new google.maps.InfoWindow({
      content: "<div>"+"中心點:"+P_center+"</Br>風向:"+kriging.predict(array_newlat[i],array_newlon[i], variogram)+"</Br>風速:"+kriging.predict(array_newlat[i],array_newlon[i], variogram1)+"</div>",
      maxWidth: 500
    });
