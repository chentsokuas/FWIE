...
<div class="w3-center">
    <div class="w3-col m10 s6">
        <input name="long0" id="long0" class="w3-input" value="資料來源:行政院環保署 Opendata:355000000I-000001" disabled></input>
...
$.ajax({
    ...
    success: function(Message) {
        ...
        btnst.onclick = function() {
                ...
                var wellCircle;
                for (var i = 0; i < num - 1; i++) {
                    var Color = 100 - Math.round((180 * obj[i].value/0.5));
