...
$.ajax({
    ...
    success: function(Message) {
        ...
        var jsonString = JSON.stringify(array_krsvalue);
        var jsonString2 = JSON.stringify(array_krsvalue1);
        var jsonString3 = JSON.stringify(array_krsvalue2);
        var jsonString4 = JSON.stringify(array_krsvalue3);
        var jsonString1 = JSON.stringify(timed);
